...
| Semana 02 | [data_intro.md](semana_02/data_intro.md) | Manipulacion de datos | Flujo inicial de preparacion, limpieza, transformacion y exploracion de datos. |
...
| Semana 02 | [pd_01a.ipynb](semana_02/pd_01a.ipynb) | Pandas I | Introduccion al trabajo con datos tabulares usando Series, DataFrames, carga de datos y exploracion basica. |
| Semana 02 | [pd_01b.ipynb](semana_02/pd_01b.ipynb) | Pandas II | Continuacion de Pandas para agrupacion, combinacion, reshaping. |
| Semana 03 | [vis_intro.md](semana_03/vis_intro.md) | Visualizacion de datos | Motivacion, buenos y malos graficos, percepcion visual y ecosistema de librerias. |
| Semana 03 | [vis_01.ipynb](semana_03/vis_01.ipynb) | Tipos de graficos | Ejemplos practicos de graficos con Matplotlib: lineas, dispersion, barras, histogramas y mas. |
...
| Tarea 2: Visualizacion de datos con Matplotlib | [tarea_02_visualizacion_eda.ipynb](evaluaciones/tarea_02_visualizacion_eda.ipynb) | Construir visualizaciones e interpretar patrones de ventas, productos, clientes y paises. | RA3.2 | 50% |
...
**Tarea 2:** los participantes deben crear graficos claros con Matplotlib, analizar tendencias, rankings, distribuciones y comunicar conclusiones orientadas a decisiones de marketing y ventas.
